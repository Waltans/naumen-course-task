...
public class Constants {
    ...
    public static final String ENTER_REMIND_DAYS_ON_SAVE = "Установить напоминание о смене пароля? Стандартное значение 30 дней, сохранить?";
    public static final String ENTER_REMIND_DAYS = "Через сколько дней напомнить о смене пароля?";
    public static final String ENTER_REMIND_DAYS_ON_SAVE_NOT_AGREE = "Через сколько дней напомнить о смене пароля? (0 - не ставить напоминание)";
